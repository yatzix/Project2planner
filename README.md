...
### Planning https://trello.com/b/KVnIu5PB/project2
...
✅ AAU I want to be able to create goals into my user profile.
✅ AAU I want to be able to add journal entries to each goal created.
